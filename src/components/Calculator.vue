        ...
        <b-col>
          <div>
            <b-dropdown
              ...
              variant="primary"
              class="m-2"
              v-model="monedaCliente"
            >
              <b-dropdown-item>Peso Colombiano (COP)</b-dropdown-item>
              <b-dropdown-item>Dolar Estadounidense (USD)</b-dropdown-item>
            </b-dropdown>
          </div>
        </b-col>
...
export default {
  ...
  computed: {
    final_value() {
      if (this.trm > 0) {
        return (this.trm * this.contribucion) / 100;
      }
      return 0;
    },
  },
